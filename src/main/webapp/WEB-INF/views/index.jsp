...
<html lang="en">
  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="res/index.html"><span class="img" style="background-image: url(res/images/author.jpg);"></span>Louie Smith</a></h1>
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li class="colorlib-active"><a href="index.html">Home</a></li>
					<li><a href="res/collection.html">Collection</a></li>
					<li><a href="res/about.html">About Me</a></li>
					<li><a href="res/services.html">My Services</a></li>
					<li><a href="res/blog.html">Blog</a></li>
	          ...
	          <div class="col-md">
	            <div class="ftco-footer-widget mb-4 ml-md-4">
	              ...
	              <ul class="list-unstyled photo">
	                <li><a href="#" class="img" style="background-image: url(res/images/image_1.jpg);"></a></li>
	                <li><a href="#" class="img" style="background-image: url(res/images/image_2.jpg);"></a></li>
	                <li><a href="#" class="img" style="background-image: url(res/images/image_3.jpg);"></a></li>
	                <li><a href="#" class="img" style="background-image: url(res/images/image_4.jpg);"></a></li>
	                <li><a href="#" class="img" style="background-image: url(res/images/image_5.jpg);"></a></li>
	                <li><a href="#" class="img" style="background-image: url(res/images/image_6.jpg);"></a></li>
	              </ul>
	            </div>
	          </div>
	          <div class="col-md">
  ...
  <script src="res/js/jquery.timepicker.min.js"></script>
  <script src="res/js/scrollax.min.js"></script>
  <script src="res/https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
